...
function AnimateButton({ text1, text2, route, getBtnColor, onClick  }) {
    ...
    return (
             <div onClick={(e) => { if (onClick) 
              ...
              className="detection-area animate-buttons"
