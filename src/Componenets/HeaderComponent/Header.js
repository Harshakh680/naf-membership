...
const automatsNavigation = {
  ...
  [t("Header.automatsDropdown.gourmetNoHeating")]: `/${currentLang}/gourmet-no-heating`,
...
const solutionsNavigation = {
  [t("Header.solutionsDropdown.nafCloud")]: `/${currentLang}/software`,
        ...
        >
          ...
          <Box
            ...
            sx={{
              ...
              alignItems: 'center',
              cursor: 'pointer',
              color: location.pathname.includes('/machine') ? '#7FEE64' : '#FCFCFC',
              fontSize: '14px',
              '&:hover': { color: '#7FEE64' }
            }}
            onMouseEnter={() => setHoveredMenu('automats')}
            onMouseLeave={() => setHoveredMenu(null)}
            onClick={() => handleNavigation(`/${currentLang}/machine`)}
          >
        ...
        >
          <Box
            ...
            sx={{
              ...
              alignItems: 'center',
              cursor: 'pointer',
              color: location.pathname.includes('/software') ? '#7FEE64' : '#FCFCFC',
              fontSize: '14px',
              '&:hover': { color: '#7FEE64' }
            }}
            onMouseEnter={() => setHoveredMenu('solutions')}
            onMouseLeave={() => setHoveredMenu(null)}
            onClick={() => handleNavigation(`/${currentLang}/software`)}
          >
            ...
            >
              {[
                ...
                <Box
                  ...
                  onClick={() => handleNavigation(solutionsNavigation[item])}
                >
                  {item}
                </Box>
              ))}
  ...
  {t("Header.Support")}
        ...
        >
          ...
          <Menu
            ...
            slotProps={{
              paper: {
                onMouseEnter: () => setLanguageAnchorEl(languageAnchorEl),
                onMouseLeave: handleLanguageMenuClose,
                sx: {
                  width: '248px',
                  height: '240px',
...
>
 ...
 transform:openDropdown === 'login'
          ? 'rotate(180deg)'
          : 'rotate(0deg)', }}> <DropDownIcon color="#FCFCFC" /> </Box>
  </Box>
...
<Box 
  ...
  onClick={(e) => {e.stopPropagation();
       handleNavigation(`/${currentLang}/machine`);
      }}
      >
  {t("Header.menuAutomats")}
...
<Box 
 ...
 onClick={(e) => {
  e.stopPropagation();
  handleNavigation(`/${currentLang}/software`);
}}
...
sx={{ display: 'flex',alignItems: 'center',color: hoveredPath === 'blogs' ? '#1A1A1A' : '#FCFCFC',cursor: 'pointer','&:hover': { color: '#1A1A1A' }}}onClick={() => {
  setLoading(true);
   window.open("https://blog.vendinaf.com/de", "_blank");
...
sx={{display: 'flex',
  alignItems: 'center',
  color: location.pathname.includes('/company/about') ? '#1A1A1A' : '#FCFCFC', 
  cursor: 'pointer',
  '&:hover': { color: '#1A1A1A' }}}
   onClick={() => {
      handleNavigation(`/${currentLang}/company/about`);
...
<Box className="menu-item bodyRegularText2" 
  ...
  {openMobileDropdown === 'login' && (
    <Box sx={{mt:2, backgroundColor: '#161616',
        borderRadius: '12px',
        padding: '12px',
        gap:'8px',
        color:'#c2c2c4',
