...
import Menu4 from '../../../assets/About/Menu/Jan.png';
import Menu5 from '../../../assets/About/Menu/feb.png';
import Menu6 from '../../../assets/About/Menu/march.png';
...
export default function MonthlyMenu() {
  ...
  return (
    <Box className="section-container" sx={{ position: 'relative' }}>
      {/* HEADER */}
      <Box
        sx={{
          display: 'flex',
      ...
      <Box
        sx={{
          ...
          gridTemplateColumns: isMobileOnly ? '1fr' : 'repeat(2, max-content)',
          gap: isMobileOnly ? '16px' : '8px',
          mb: 4,
