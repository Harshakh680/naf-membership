...
import { FoodservationIcon, Qrscanner, Livemenu, Machinelocations, MembersPersonIcon, WalletOrangeicon, Blocksicon, MembersVerfiedIcon, CentralAccessIcon, VendingMachineIcon, BadgeIconOrange } from "../../Componenets/CustomIcons";
 ...
 useEffect(() => {
    ...
    return (
        <Box  sx={{  mt: { xs: "80px", sm: "120px", md: "160px", lg: "200px" }, px: { xs: 0, sm: 4, md: 6, lg: 0 } }}>
            ...
            <Box
                sx={{ 
                    mt: { xs: "80px", sm: "150px", md: "200px", lg: "250px" },
                    width: "100%",
                ...
                <Box sx={{ mt: { xs: 4, sm: 5 } }}>
                    <Box sx={{ 
                        ...
                        {appFeatures.map((item, index) => (
                            <Box key={index} sx={{ minHeight: { xs: 'auto', sm: '200px' },mb: { xs: 5, sm: 0 }  }}>
                                <Box
                                    sx={{
                                        height: "100%",
                                        display: "flex",
