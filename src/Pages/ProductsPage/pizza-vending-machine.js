...
export default function PizzaAutomatPage() {
  ...
  const handleDirectPurchase = () => {
    openModal("Pizza Machine", "Direct Purchase");
  };
 
  const handleLeasing = () => {
    openModal("Pizza Machine", "Leasing");
  };

  const handleRentalPurchase = () => {
    openModal("Pizza Machine", "Hire Purchase");
  };

  const handleSummerSeasonal = () => {
    openModal("Pizza Machine", "Leasing Purchase"); 
  };
                   ...
                   {[
                     {
                       ...
                       items: [
                         ...
                         t('products.PizzatMachine.accessories.category1.item4')
                       ],
                     },
                     {
                     ...
                     {
                       title: t('products.PizzatMachine.accessories.category6.title'),
                       items: [
                     ...
                     <Grid item xs={12} sm={6} md={4} key={index}>
                       <Box sx={{
                         ...
                         <List sx={{ p: 0, listStyleType: "disc" }}>
                      ...
                      >
                        ...
                        >
                          <Typography sx={{ textAlign: 'center', mb: 2, color: '#c2c2c4' }} className="bodyRegularText2">
                            {t('products.PizzaMachine.pricing.purchase.title')}
                          </Typography>
            
                          <Typography sx={{ textAlign: 'center', mb: 2, color: '#FA7854' }} className="headings-h4">
                            {t('products.PizzaMachine.pricing.purchase.price')}
                          </Typography>
                                ...
                                >
                                  ...
                                  >
                                    <Typography sx={{ textAlign: 'center', mb: 2, color: '#c2c2c4' }} className="bodyRegularText3">
                                      {t('products.PizzaMachine.pricing.hirePurchase.title')}
                                    </Typography>
