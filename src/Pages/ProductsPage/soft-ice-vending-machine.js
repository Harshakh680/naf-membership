...
import '../../App.css';
import './products.css';
import VendImg from '../../assets/Home/Ice-cream-machine.png';
import {
  Box,
  Button,
  Typography,
...
export default function IceCreamVendingMachineContent() {
  ...
  const faqData = [
    {
      question: t('products.icecreamMachine.faq.question1'),
      answer: t('products.icecreamMachine.faq.answer1')
    },
    {
      question: t('products.icecreamMachine.faq.question2'),
      answer: t('products.icecreamMachine.faq.answer2')
    },
    {
      question: t('products.icecreamMachine.faq.question3'),
      answer: t('products.icecreamMachine.faq.answer3')
    },
    {
      question: t('products.icecreamMachine.faq.question4'),
      answer: t('products.icecreamMachine.faq.answer4')
    },
    {
      question: t('products.icecreamMachine.faq.question5'),
      answer: t('products.icecreamMachine.faq.answer5')
    },
    {
      question: t('products.icecreamMachine.faq.question6'),
      answer: t('products.icecreamMachine.faq.answer6')
    },
    {
      question: t('products.icecreamMachine.faq.question7'),
      answer: t('products.icecreamMachine.faq.answer7')
    },
    {
      question: t('products.icecreamMachine.faq.question8'),
      answer: t('products.icecreamMachine.faq.answer8')
    },
    {
      question: t('products.icecreamMachine.faq.question9'),
      answer: t('products.icecreamMachine.faq.answer9')
    },
    {
      question: t('products.icecreamMachine.faq.question10'),
      answer: t('products.icecreamMachine.faq.answer10')
    }
  ];
  ...
  const handleDirectPurchase = () => {
    openModal("Gourmet Machine", "Direct Purchase");
  };

  const handleLeasing = () => {
    openModal("Gourmet Machine", "Leasing");
  };

  const handleRentalPurchase = () => {
    openModal("Gourmet Machine", "Hire Purchase");
  };

  const handleSummerSeasonal = () => {
    openModal("Gourmet Machine", "Leasing Purchase"); 
  };
    ...
    <div className="section-container main-container" style={{ height: '100%', display: 'block', flexDirection: 'column' }}>
      ...
      >
        <Box className="product_hero_text" sx={{ color: "#fff", width: '50%', pt: 10 }}>
          <h1 className='headings-h1 gourmate_Heading ' sx={{ color: '#C2C2C4', py: { xs: '8px', sm: '8px', md: '16px' }, letterSpacing: '-0.84px', margin: "10px 0px !important", width: '60%' }}>
            {t('products.icecreamMachine.title')}
          </h1>
          <Typography
            sx={{
              fontSize: "16px",
          ...
          >
            {t('products.icecreamMachine.subtitle')}
          </Typography>
          <Box sx={{mt:4}}>
      ...
      <Box sx={{ mt: 8, mb: 8 }}>
        <Typography variant="h2" className='headings-h2' sx={{ color: '#fcfcfc', mb: 2, textAlign:'center' }}>
          {t('products.icecreamMachine.specifications.title')}
        </Typography>
        <Typography variant="body1" className='bodyRegularText3' sx={{ color: '#C2C2C4', mb: 4, textAlign:'center' }}>
          {t('products.icecreamMachine.specifications.subtitle')}
        </Typography>
        ...
        <Grid container spacing={1}>
          ...
          <Grid item xs={12} sm={4}>
            <Paper sx={{ 
              ...
              <Typography variant="body2" className='bodyRegularText4' color='#9D9EA1' sx={{ mb: 1 }}>
                {t('products.icecreamMachine.specifications.dimensions')}
              </Typography>
              <Typography variant="h5" fontWeight="bold" color='#FCFCFC' className='bodyRegularText4'>
                {t('products.icecreamMachine.specifications.dimensionsValue')}
              </Typography>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} sm={4}>
            <Paper sx={{ 
              ...
              <Typography variant="body2" className='bodyRegularText4' color='#9D9EA1' sx={{ mb: 1 }}>
                {t('products.icecreamMachine.specifications.weight')}
              </Typography>
              <Typography variant="h5" fontWeight="bold" color='#FCFCFC' className='bodyRegularText4'>
                {t('products.icecreamMachine.specifications.weightValue')}
              </Typography>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} sm={4}>
            <Paper sx={{ 
              ...
              <Typography variant="body2" className='bodyRegularText4' color='#9D9EA1' sx={{ mb: 1 }}>
                {t('products.icecreamMachine.specifications.powerSupply')}
              </Typography>
              <Typography variant="h5" fontWeight="bold" color='#FCFCFC' className='bodyRegularText4'>
                {t('products.icecreamMachine.specifications.powerSupplyValue')}
              </Typography>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} sm={4}>
            <Paper sx={{ 
              ...
              <Typography variant="body2" className='bodyRegularText4' color='#9D9EA1' sx={{ mb: 1 }}>
                {t('products.icecreamMachine.specifications.temperatureRange')}
              </Typography>
              <Typography variant="h5" fontWeight="bold" color='#FCFCFC' className='bodyRegularText4'>
                {t('products.icecreamMachine.specifications.temperatureRangeValue')}
              </Typography>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} sm={4}>
            <Paper sx={{ 
              ...
              <Typography variant="body2" className='bodyRegularText4' color='#9D9EA1' sx={{ mb: 1 }}>
                {t('products.icecreamMachine.specifications.connectivity')}
              </Typography>
              <Typography variant="h5" fontWeight="bold" color='#FCFCFC' className='bodyRegularText4'>
                {t('products.icecreamMachine.specifications.connectivityValue')}
              </Typography>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} sm={4}>
            <Paper sx={{ 
              ...
              <Typography className='bodyRegularText4' color='#9D9EA1' sx={{ mb: 1 }}>
                {t('products.icecreamMachine.specifications.heatingTime')}
              </Typography>
              <Typography fontWeight="bold" color='#FCFCFC' className='bodyRegularText4'>
                {t('products.icecreamMachine.specifications.heatingTimeValue')}
              </Typography>
            </Paper>
          </Grid>
        </Grid>
      ...
      <Box sx={{ mt: 10, mb: 18, width: '100%' }}>
        ...
        <Grid container spacing={2}>
          ...
          {t('products.icecreamMachine.installation.title')}
        </Typography>
            <Box sx={{
              ...
              <List sx={{ p: 0, mt: 2 }}>
                {[
                  t('products.icecreamMachine.installation.requirement1'),
                  t('products.icecreamMachine.installation.requirement2'),
                  t('products.icecreamMachine.installation.requirement3'),
                  t('products.icecreamMachine.installation.requirement4'),
                  t('products.icecreamMachine.installation.requirement5')
                ].map((item, index) => (
                  <ListItem key={index} sx={{ p: 0, mb: 3, display: 'flex', alignItems: 'flex-start' }}>
          ...
          <Grid item xs={6} md={6}>
            <Box sx={{ px: 4, height: '100%', }}>
              <Typography variant="h3" sx={{ 
                ...
                {t('machines.IdealFor') || "Ideal use cases"}
              </Typography>

              <Grid container spacing ={{ xs: 7, md: 2 }}>
                {[
                  ...
                  <Grid item xs={6} sm={3} md={3} key={index} sx={{display:"flex",flexDirection:'column',justify:"center",alignItems:"center"}}>
                    <Box sx={{ mb: 2 }}>
                      {item.icon}
                    </Box>
                    <Typography sx={{ 
      ...
      <Box sx={{ mt: { sm: 8, md: 18 }, mb: 8,pt:8, width: '100%' }}>
        <Typography
        ...
        >
          {t('products.icecreamMachine.features.title')}
        </Typography>
          ...
          {[
            {
              ...
              title: t('products.icecreamMachine.features.feature1.title'),
              description: t('products.icecreamMachine.features.feature1.description'),
            },
            {
              icon: (
                <svg
              ...
              title: t('products.icecreamMachine.features.feature2.title'),
              description: t('products.icecreamMachine.features.feature2.description'),
            },
            {
              icon: (
                <svg
              ...
              title: t('products.icecreamMachine.features.feature3.title'),
              description: t('products.icecreamMachine.features.feature3.description'),
            },
            {
              icon: (
                <svg
              ...
              title: t('products.icecreamMachine.features.feature4.title'),
              description: t('products.icecreamMachine.features.feature4.description'),
            },
            {
              icon: (
                <svg
              ...
              title: t('products.icecreamMachine.features.feature5.title'),
              description: t('products.icecreamMachine.features.feature5.description'),
            },
            {
              icon: (
                <svg
              ...
              title: t('products.icecreamMachine.features.feature6.title'),
              description: t('products.icecreamMachine.features.feature6.description'),
            },
          ].map((feature, index) => (
      ...
      <Box sx={{ mt: 18, mb: 8, width: '100%' }}>
        ...
        <Grid container rowSpacing={7} columnSpacing={2}>
          {[
            {
              title: t('products.icecreamMachine.accessories.category1.title'),
              items: [
                // t('products.icecreamMachine.accessories.category1.item1'),
                // t('products.icecreamMachine.accessories.category1.item2'),
                t('products.icecreamMachine.accessories.category1.item3'),
                t('products.icecreamMachine.accessories.category1.item4')
              ],
            },
            {
              title: t('products.icecreamMachine.accessories.category2.title'),
              items: [
                t('products.icecreamMachine.accessories.category2.item1'),
                t('products.icecreamMachine.accessories.category2.item2'),
                t('products.icecreamMachine.accessories.category2.item3'),
                t('products.icecreamMachine.accessories.category2.item4'),
                t('products.icecreamMachine.accessories.category2.item5')
              ],
            },
            {
              title: t('products.icecreamMachine.accessories.category3.title'),
              items: [
                t('products.icecreamMachine.accessories.category3.item1'),
                t('products.icecreamMachine.accessories.category3.item2'),
                t('products.icecreamMachine.accessories.category3.item3'),
                t('products.icecreamMachine.accessories.category3.item4')
              ],
            },
            {
              title: t('products.icecreamMachine.accessories.category4.title'),
              items: [
                // t('products.icecreamMachine.accessories.category4.item1'),
                t('products.icecreamMachine.accessories.category4.item2'),
                t('products.icecreamMachine.accessories.category4.item3'),
                t('products.icecreamMachine.accessories.category4.item4'),
                t('products.icecreamMachine.accessories.category4.item5')
              ],
            },
            {
              title: t('products.icecreamMachine.accessories.category5.title'),
              items: [
                t('products.icecreamMachine.accessories.category5.item1'),
                t('products.icecreamMachine.accessories.category5.item2'),
                t('products.icecreamMachine.accessories.category5.item3'),
                t('products.icecreamMachine.accessories.category5.item4')
              ],
            },
            {
              title: t('products.icecreamMachine.accessories.category6.title'),
              items: [
                t('products.icecreamMachine.accessories.category6.item1'),
                t('products.icecreamMachine.accessories.category6.item2'),
                t('products.icecreamMachine.accessories.category6.item3'),
                t('products.icecreamMachine.accessories.category6.item4')
              ],
            }
          ].map((category, index) => (
            <Grid item xs={12} sm={6} md={4} key={index}>
              <Box sx={{
                ...
                <List sx={{ pl: "20px", listStyleType: "disc" }}>
...
<Box sx={{ mt: 18, mb: 8, px: { xs: 0, md: 2 }, width: '100%', boxSizing: 'border-box' }}>
        <Box sx={{ mb: { xs: 3, md: 4 }, textAlign: 'center' }}>
          <Typography variant="h2" className='headings-h2' sx={{ color: '#fcfcfc', mb: 2, textAlign: 'center' }}>
            {t('products.icecreamMachine.pricing.title')}
          </Typography>
          <Typography className="bodyRegularText3" sx={{ color: '#c2c2c4', mb: 1, textAlign: 'center' }}>
            {t('products.icecreamMachine.pricing.subtitle')}
          </Typography>
        </Box>
        ...
        >
          ...
          >
            ...
            >
              <Typography sx={{ textAlign: 'center', mb: 2, color: '#c2c2c4' }} className="bodyRegularText2">
                {t('products.icecreamMachine.pricing.purchase.title')}
              </Typography>

              <Typography sx={{ textAlign: 'center', mb: 2, color: '#FA7854' }} className="headings-h4">
                {t('products.icecreamMachine.pricing.purchase.price')}
              </Typography>

              <Typography sx={{ textAlign: 'center', color: '#c2c2c4', mb: 1 }} className="bodyRegularText3">
                {t('products.icecreamMachine.pricing.purchase.frequency')}
              </Typography>
              ...
              <List sx={{ p: 0, my: { xs: 4, md: 8 }, flexGrow: 1 }}>
                {[1, 2, 3, 4, 5].map((i) => (
                  <ListItem key={i}>
                    ...
                    >
                      {t(`products.icecreamMachine.pricing.purchase.benefit${i}`)}
                    </Typography>
                  </ListItem>
                ))}
              </List>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'center', mt: 'auto', pt: 2 }}>
                ...
                >
                  {t('products.icecreamMachine.pricing.getStarted')}
                </Button>
              </Box>
            </Box>
          </Box>
          ...
          >
            ...
            >
              <Typography sx={{ textAlign: 'center', mb: 2, color: '#c2c2c4' }} className="bodyRegularText2">
                {t('products.icecreamMachine.pricing.leasing.title')}
              </Typography>

              <Typography sx={{ textAlign: 'center', mb: 2, color: '#FA7854' }} className="headings-h4">
                {t('products.icecreamMachine.pricing.leasing.price')}
              </Typography>

              <Typography sx={{ textAlign: 'center', color: '#c2c2c4', mb: 1 }} className="bodyRegularText3">
                {t('products.icecreamMachine.pricing.leasing.frequency')}
              </Typography>
              ...
              <List sx={{ p: 0, my: { xs: 4, md: 8 }, flexGrow: 1 }}>
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <ListItem key={i}>
                    ...
                    >
                      {t(`products.icecreamMachine.pricing.leasing.benefit${i}`)}
                    </Typography>
                  </ListItem>
                ))}
              </List>
          ...
          >
            ...
            >
              <Typography sx={{ textAlign: 'center', mb: 2, color: '#c2c2c4' }} className="bodyRegularText3">
                {t('products.icecreamMachine.pricing.hirePurchase.title')}
              </Typography>

              <Typography sx={{ textAlign: 'center', mb: 2, color: '#FA7854' }} className="headings-h4">
                {t('products.icecreamMachine.pricing.hirePurchase.price')}
              </Typography>

              <Typography sx={{ textAlign: 'center', color: '#c2c2c4', mb: 1 }} className="bodyRegularText3">
                {t('products.icecreamMachine.pricing.hirePurchase.frequency')}
              </Typography>
              ...
              <List sx={{ p: 0, my: { xs: 4, md: 8 }, flexGrow: 1 }}>
                {[1, 2, 3, 4, 5].map((i) => (
                  <ListItem key={i}>
                    ...
                    >
                      {t(`products.icecreamMachine.pricing.hirePurchase.benefit${i}`)}
                    </Typography>
                  </ListItem>
                ))}
              </List>
      ...
      >
        ...
        >
          {t('products.icecreamMachine.seasonal.title')}
        </Typography>
        ...
        >
            ...
            >
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ color: '#FCFCFC' }} className="bodyRegularText3">
                  {t('products.icecreamMachine.seasonal.summer.title')}
                </Typography>
              ...
              <Typography sx={{ color: '#C2C2C4', mb: 4 }} className="bodyRegularText4">
                {t('products.icecreamMachine.seasonal.summer.period')}
              </Typography>

              <Box sx={{ mt: 1, mb: 2 }}>
                <Typography sx={{ color: '#FA7854' }} className="bodyRegularText2">
                  {t('products.icecreamMachine.seasonal.summer.price')}
                </Typography>
              </Box>

              <Typography sx={{ color: '#C2C2C4', flexGrow: 1 }} className="bodyRegularText4">
                {t('products.icecreamMachine.seasonal.summer.description')}
              </Typography>
          ...
          >
            ...
            >
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ color: '#FCFCFC' }} className="bodyRegularText3">
                  {t('products.icecreamMachine.seasonal.winter.title')}
                </Typography>
              ...
              <Typography sx={{ color: '#C2C2C4', mb: 4 }} className="bodyRegularText4">
                {t('products.icecreamMachine.seasonal.winter.period')}
              </Typography>
              <Box sx={{ mt: 1, mb: 2 }}>
                <Typography sx={{ color: '#E56A47' }} className="bodyRegularText2">
                  {t('products.icecreamMachine.seasonal.winter.price')}
                </Typography>
              </Box>

              <Typography sx={{ color: '#C2C2C4', flexGrow: 1 }} className="bodyRegularText4">
                {t('products.icecreamMachine.seasonal.winter.description')}
              </Typography>
      ...
      >
        <Typography sx={{ color: '#FCFCFC', flex: 1 }} className="bodyRegularText3">
          {t('products.icecreamMachine.customQuote.text')}
        </Typography>
        <Button
          sx={{
            backgroundColor: '#fcfcfc',
        ...
        >
          {t('products.icecreamMachine.customQuote.button')}
        </Button>
      </Box>
      ...
      <Box sx={{ mt: { xs: 10, md: 12 }, py: { xs: 6, md: 8 }, width: '100%' }}>
        <Box sx={{ mb: { xs: 5, md: 7 }, textAlign: 'center' }}>
          <Typography className="headings-h2" sx={{ color: '#fcfcfc' }}>
            {t('products.icecreamMachine.faq.title')}
          </Typography>
          <Typography className="bodyMediumText2" sx={{ color: '#C2C2C4' }}>
            {t('products.icecreamMachine.faq.subtitle')}
          </Typography>
        </Box>
