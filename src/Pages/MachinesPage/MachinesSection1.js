...
const getProductRoute = (machineTitle) => {
  const productRoutes = {
    ...
    [t('machines.PizzaMachine')]: 'pizza-vending-machine', 
    [t('machines.IceCreamMachine')]: 'soft-ice-vending-machine', 
                    ...
                    <Box className='section-container'
                        ...
                        <Box sx={{ flex: 1, display: 'flex', gap: '10px', flexDirection: 'column' }}>
                            ...
                            <Box sx={{ display: "flex", justifyContent: "center", mt: 2, gap: 6 }}>
                              ...
                              <AnimateButton  text1={t('AnimateBtn.learn')} text2={t('AnimateBtn.more')}  route={ index === 0 || index === 2? getProductRoute(machine.title) : `/${lang}/contact`}/>
