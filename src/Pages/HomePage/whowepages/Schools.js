...
const [expandedFaqIndex, setExpandedFaqIndex] = useState(null);
 ...
 const handleScrollToContact = () => {
  ...
  if (contactSection) {
   ...
   const faqData = [
    {
      question: t('schools.faq.question1'),
      answer: t('schools.faq.answer1')
    },
    {
      question: t('schools.faq.question2'),
      answer: t('schools.faq.answer2')
    },
    {
      question: t('schools.faq.question3'),
      answer: t('schools.faq.answer3')
    },
    {
      question: t('schools.faq.question4'),
      answer: t('schools.faq.answer4')
    },
    {
      question: t('schools.faq.question5'),
      answer: t('schools.faq.answer5')
    },
    {
      question: t('schools.faq.question6'),
      answer: t('schools.faq.answer6')
    }
  ];
  const machines = [
    {
  ...
  return (
    <>
      ...
      <Box sx={{ mt: { xs: 8, md: 16 }, width: '100%', boxSizing: 'border-box' }}>
        ...
        ), url(${school}) lightgray 50% / cover no-repeat`,
        }}
        >
          <Box sx={{
        ...
        <Grid container
                ...
                >
                  {[
                    ...
                    {
                      title: t('schools.advantage1Title'),
                      description:
                        t('schools.advantage1Desc'),
        
                    },
                    {
                      title: t('schools.advantage2Title'),
                      description:
                        t('schools.advantage2Desc'),
                    },
                    {
                      title: t('schools.advantage3Title'),
                      description:
                        t('schools.advantage3Desc'),
                    },
                    {
                      title: t('schools.advantage4Title'),
                      description:
                        t('schools.advantage4Desc'),
                    },
                    {
                      title: t('schools.advantage5Title'),
                      description:
                        t('schools.advantage5Desc'),
                    },
                    {
                      title: t('schools.advantage6Title'),
                      description:
                        t('schools.advantage6Desc'),
                    },
                  ].map((feature, index) => (
