...
import transport from '../../../assets/Home/Gas-stations-&-rest-areas.avif';
...
const Transpotationpage = () => {
  ...
  const faqData = [
    {
      question: t('transportation.faq.question1'),
      answer: t('transportation.faq.answer1')
    },
    {
      question: t('transportation.faq.question2'),
      answer: t('transportation.faq.answer2')
    },
    {
      question: t('transportation.faq.question3'),
      answer: t('transportation.faq.answer3')
    },
    {
      question: t('transportation.faq.question4'),
      answer: t('transportation.faq.answer4')
    },
    {
      question: t('transportation.faq.question5'),
      answer: t('transportation.faq.answer5')
    },
    {
      question: t('transportation.faq.question6'),
      answer: t('transportation.faq.answer6')
    },
    {
      question: t('transportation.faq.question7'),
      answer: t('transportation.faq.answer7')
    }
  ];
  ...
  return (
    <>
      ...
      <Box sx={{ mt: { xs: 8, md: 16 }, width: '100%', boxSizing: 'border-box' }}>
        ...
        <Box sx={{
          ...
          background: `linear-gradient(
             ...
             ), url(${transport}) lightgray 50% / cover no-repeat`,
        }}
        >
          <Box sx={{
      ...
      <Box sx={{ px: { xs: 2, sm: 6 }, mt: { xs: 8, md: 25 }, mb: 8 }}>
        ...
        >
          {t('transportation.advantagesTitle')}
        </Typography>
        ...
        >
          {[
            {
              title: t('transportation.advantage1Title'),
              description: t('transportation.advantage1Desc'),
            },
            {
              title: t('transportation.advantage2Title'),
              description: t('transportation.advantage2Desc'),
            },
            {
              title: t('transportation.advantage3Title'),
              description: t('transportation.advantage3Desc'),
            },
            {
              title: t('transportation.advantage4Title'),
              description: t('transportation.advantage4Desc'),
            },
            {
              title: t('transportation.advantage5Title'),
              description: t('transportation.advantage5Desc'),
            },
            {
              title: t('transportation.advantage6Title'),
              description: t('transportation.advantage6Desc'),
            },
          ].map((feature, index) => (
  ...
  <circle cx="12" cy="12" r="12" fill="#FA7854"/>
        ...
        <Box sx={{ mt: { xs: 8, md: 35 }, mb: 4 }}>
          <Typography sx={{
            ...
            {t('transportation.suitableTitle')}
          </Typography>
          <Typography sx={{ color: '#c2c2c4' }} className='bodyRegularText3'>
            {t('transportation.suitableSubtitle')}
          </Typography>
        </Box>
