...
import factory from '../../../assets/Home/Companies-&-factories.avif';
...
const FactoryPage = () => {
  ...
  if (contactSection) {
    contactSection.scrollIntoView({ behavior: 'smooth' });
     ...
     const faqData = [
      {
        question: t('factories.faq.question1'),
        answer: t('factories.faq.answer1')
      },
      {
        question: t('factories.faq.question2'),
        answer: t('factories.faq.answer2')
      },
      {
        question: t('factories.faq.question3'),
        answer: t('factories.faq.answer3')
      },
      {
        question: t('factories.faq.question4'),
        answer: t('factories.faq.answer4')
      },
      {
        question: t('factories.faq.question5'),
        answer: t('factories.faq.answer5')
      },
      {
        question: t('factories.faq.question6'),
        answer: t('factories.faq.answer6')
      },
      {
        question: t('factories.faq.question7'),
        answer: t('factories.faq.answer7')
      }
    ];
  ...
  return (
    <>
      ...
      <Box sx={{ mt: { xs: 8, md: 16 }, width: '100%', boxSizing: 'border-box' }}>
        ...
        ), url(${factory}) lightgray 50% / cover no-repeat`,
        }}
        >
          <Box sx={{
      ...
      {/* CONTENT SECTION */}
      <Box sx={{  px: { xs: 2, sm: 6 }, mt:5, py: 6 }}>
        <Typography className="bodyRegularText3" sx={{ color: '#c2c2c4' }}>
        {t('factories.introText1')}
        </Typography>
      ...
      <Box sx={{ px: { xs: 2, sm: 6 }, mt: { xs: 8, md: 25 }, mb: 8 }}>
        ...
        <Grid container
                ...
                >
                  {[
                    {
                      title: t('factories.advantage1Title'),
                      description:
                        t('factories.advantage1Desc'),
                    },
                    {
                      title: t('factories.advantage2Title'),
                      description:
                        t('factories.advantage2Desc'),
                    },
                    {
                      title: t('factories.advantage3Title'),
                      description:
                        t('factories.advantage3Desc'),
                    },
                    {
                      title: t('factories.advantage4Title'),
                      description:
                        t('factories.advantage4Desc'),
                    },
                    {
                      title: t('factories.advantage5Title'),
                      description:
                        t('factories.advantage5Desc'),
        
                    },
                    {
                      title: t('factories.advantage6Title'),
                      description:
                        t('factories.advantage6Desc'),
                    },
                  ].map((feature, index) => (
